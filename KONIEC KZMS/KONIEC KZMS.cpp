...
//BARDZO PRZYDATNE, BY NIE WPISYWAÆ CI¥GLE STD PRZED KOMENDAMI
using namespace std;
...
//DO WHILE, WYBÓR DLA U¯YTKOWNIKA JAK PROGRAM SIÊ ZAKOÑCZY
do{
...
switch( wyborprocenty ) //Kolejny wybór, ale tym razem do procentów (Wewnêtrzny)
    ...
    default: //Jest to domyœlna opcja która aktywuje siê, gdy u¿ytkownik wpiszê coœ poza nasz¹ opcj¹ (1-8)
      cout << "Prosze wybrac funkcje! (1-11)" << endl;
		...
		//CZY PROGRAM MA SIÊ ZAKOÑCZYÆ?
         cout <<"\n\nCzy chcesz zakonczyc prace petli: t/n? ";
         cin >> znak;
         system ("cls");
    }
    while (znak != 't'); //JE¯ELI U¯YTKOWNIK NAPISZE t PROGRAM SIÊ ZAKOÑCZY
    
    return 0;
} 

//ZROBIONE [K¯ + MŒ]- 0.Odbieranie danych od u¿ytkownika, gdy bêdzie to wymagane

//ZROBIONE [MŒ]- 1.Dodawanie: sk³adnik + sk³adnik = suma

//ZROBIONE [MŒ]-2.Odejmowanie: Odjemna – odjemnik = ró¿nica
...
//ZROBIONE [MŒ]-6.Potêgowanie – dzia³anie dwuargumentowe (n-ta potêga)

//ZROBIONE [K¯]-7.Silnia liczby naturalnej n

//ZROBIONE [MŒ]-8.Pierwiastek (n-ty pierwiastek)

//ZROBIONE [K¯ + MŒ]- 9.Modulo (Czy zostanie reszta z dzielenia 2 liczb)

//ZROBIONE [MŒ]- 10.Inkrementacja (zwiêkszenie wartoœci zmiennej o jeden)

//ZROBIONE [K¯]- 11.Dekrementacja (zmniejszenie wartoœci zmiennej o jeden)

//ZROBIONE [K¯ + MŒ]- 12. Czytelne wypisywanie wyniku z funkcji dla u¿ytkownika

//ZROBIONE [K¯ + MŒ]- 13. Wybór, czy program ma siê zakoñczyæ, czy powróciæ do menu

//ZROBIONE [K¯ + MŒ] - INNE DODATKOWE, NIE PRZYPISANE RZECZY
